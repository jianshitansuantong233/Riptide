...
class CNN_Medium(tf.keras.Model):
   def __init__(self):
      ...
      self.conv1 = nn.NormalConv2D(128, 3, padding='same', activation='relu')
      ...
      # Output
      self.conv7 = nn.NormalConv2D(filters=10, kernel_size=4, activation='relu', padding='valid', use_bias=False)
